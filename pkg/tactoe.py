...
#   champ = AI(boardSize, 'Champ', 'Challenger', bestParams, bestUserParams, GameEssentials.lines)
...
#   challenger = AI(boardSize, 'Challenger', 'Champ', challengerParams, challengerUserParams, GameEssentials.lines)
  
#   # print 'The Champ:', bestParams, bestUserParams
#   # print 'The Challenger:', challengerParams, challengerUserParams

#   game = Game(champ, challenger, GameEssentials.lines)
